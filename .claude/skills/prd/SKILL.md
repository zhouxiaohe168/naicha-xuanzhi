...
**在问任何功能之前，先还原用户的真实决策过程。**

> "你的用户在使用这个产品之前，脑子里在想什么？他今天想做什么事？他会怎么一步步做决定？"
...
**⚠️ 反模式警告**：如果产品逻辑是"展示我们有什么" → 用户自己找需要的，说明还没想清楚用户视角，必须重新来。

**正确的设计方向**：用户带着一个具体问题进来 → 产品直接回答这个问题。
